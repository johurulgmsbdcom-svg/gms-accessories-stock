...
CREATE TABLE IF NOT EXISTS "public"."bot_context" (
...
ALTER TABLE "public"."bot_context" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."bot_context"
    ADD CONSTRAINT "bot_context_pkey" PRIMARY KEY ("chat_id");
...
CREATE POLICY "bot_context_allow_all" ON "public"."bot_context" USING (true) WITH CHECK (true);
...
CREATE POLICY "scheduled_reports_allow_all" ON "public"."scheduled_reports" USING (true) WITH CHECK (true);
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."buyers";
...
GRANT ALL ON TABLE "public"."bot_context" TO "anon";
GRANT ALL ON TABLE "public"."bot_context" TO "authenticated";
GRANT ALL ON TABLE "public"."bot_context" TO "service_role";
